  ...
  return (
    <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g transform="translate(32,32)">
        ...
        <ellipse cx="0" cy="-12" rx="7" ry="12" fill="url(#sg)" opacity="0.9" transform="rotate(72)"/>
        <ellipse cx="0" cy="-12" rx="7" ry="12" fill="url(#sg)" opacity="0.9" transform="rotate(144)"/>
        <ellipse cx="0" cy="-12" rx="7" ry="12" fill="url(#sg)" opacity="0.9" transform="rotate(216)"/>
        <ellipse cx="0" cy="-12" rx="7" ry="12" fill="url(#sg)" opacity="0.9" transform="rotate(288)"/>
