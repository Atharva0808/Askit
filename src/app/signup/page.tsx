  ...
  return (
    <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g transform="translate(32,32)">
        ...
        <ellipse cx="0" cy="-12" rx="7" ry="12" fill="url(#sg_signup)" opacity="0.9" transform="rotate(72)" />
        <ellipse cx="0" cy="-12" rx="7" ry="12" fill="url(#sg_signup)" opacity="0.9" transform="rotate(144)" />
        <ellipse cx="0" cy="-12" rx="7" ry="12" fill="url(#sg_signup)" opacity="0.9" transform="rotate(216)" />
        <ellipse cx="0" cy="-12" rx="7" ry="12" fill="url(#sg_signup)" opacity="0.9" transform="rotate(288)" />
      ...
      <div className="hidden lg:flex lg:w-[45%] flex-col justify-between px-12 py-10 bg-[#08080a] dot-grid relative">
        ...
        <div className="relative z-10 pr-8 max-w-md">
          ...
          <p className="text-neo-white-muted text-sm leading-relaxed max-w-sm mb-8">
            Create your account in seconds. Upload documents, connect your
            knowledge, and let AI do the heavy lifting.
          </p>
      ...
      <div className="w-full lg:w-[55%] flex items-center justify-center p-6 bg-neo-black">
        <div className="w-full max-w-md">
          ...
          <p className="text-neo-white-muted text-sm mb-8">
            Get started with Askit in seconds.
          </p>
          ...
          {message && (
            <div className="mb-5 p-3 rounded-lg bg-emerald-500/8 border border-emerald-500/15 text-emerald-400 text-sm neo-fade-in">
              {message}
            </div>
          )}
          ...
          <p className="mt-8 text-center text-neo-white-muted text-sm">
            ...
            <Link href="/login" className="text-neo-pink hover:underline">
              Log in
            </Link>
          </p>
        </div>
